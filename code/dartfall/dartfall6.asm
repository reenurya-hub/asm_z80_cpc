...
db #55,#6E,#80,#64,#61,#72,#64,#6F,#80,#73,#65,#80,#6D,#75,#65,#76,#65,#80,#6C,#61,#64,#6F,#80,#61,#80,#6C,#61,#64,#6F,#2E ;;51
;; Enter-Nva linea [2]
db #0D,#0A ;;53
;;  O   b   j   e   t   i   v   o   :   (_) t   e   n   e   r   (_) p   r   e   c   i   s   i   o   n [24]
db #4F,#62,#6A,#65,#74,#69,#76,#6F,#3A,#80,#74,#65,#6E,#65,#72,#80,#70,#72,#65,#63,#69,#73,#69,#6F,#6E ;;6C
;; Enter-Nva linea [2]
db #0D,#0A ;;6E
;;  p   a   r   a   (_) d   i   s   p   a   r   a   r   (_) h   a   c   i   a   (_)  e   l  (_) b   l   a   n   c   o [29]
db #70,#61,#72,#61,#80,#64,#69,#73,#70,#61,#72,#61,#72,#80,#68,#61,#63,#69,#61,#80,#65,#6C,#80,#62,#6C,#61,#6E,#63,#6F ;;8B
;; Enter-Nva linea [2]
db #0D,#0A ;;8D
;;  d   e   (_) l   a   (_) p   a   n   t   a   l   l   a   . [14]
db #64,#65,#80,#6C,#61,#80,#70,#61,#6E,#74,#61,#6C,#6C,#61,#2E ;;9C
;;Enter-Nva linea [2]
db #0D,#0A ;;9E
;;  P   r   e   p   a   r   a   ,   (_) a   p   u   n   t   a   (_) y   (_) d   i   s   p   a   r   a   (_) c   o   n   (_) E   S   P   A   C   I   O [37]
db #50,#72,#65,#70,#61,#72,#61,#2C,#80,#61,#70,#75,#6E,#74,#61,#80,#79,#80,#64,#69,#73,#70,#61,#72,#61,#80,#63,#6F,#6E,#80,#45,#53,#50,#41,#43,#49,#4F ;;C3
;;Enter-Nva linea [2]
db #0D,#0A ;;C5
;; C   a   d   a   (_) n   i   v   e   l   (_) i   n   c   r   e   m   e   n   t   a   (_) l   a  (_)  d   i   f   i   c   u   l   t   a   d   . [36]
db #43,#61,#64,#61,#80,#6E,#69,#76,#65,#6C,#80,#69,#6E,#63,#72,#65,#6D,#65,#6E,#74,#61,#80,#6C,#61,#80,#64,#69,#66,#69,#63,#75,#6C,#74,#61,#64,#2E ;;E9
;;Enter-Nva linea [2]
db #0D,#0A ;;EB
;ret
Texto2:
;;  P   r   e   s   i   o   n   a   (_) c   u   a   l   q   u   i   e   r   (_) t   e   c  
db #50,#72,#65,#73,#69,#6F,#6E,#61,#80,#63,#75,#61,#6C,#71,#75,#69,#65,#72,#80,#74,#65,#63 ;;16
;;  l   a   (_) p   a   r   a   (_) s   e   g   u   i   r   ! [36]
db #6C,#61,#80,#70,#61,#72,#61,#80,#73,#65,#67,#75,#69,#72,#21 ;;25
;;Enter-Nva linea [2]
;;db #0D,#0A ;;27
;ret
;;
...
;;
ld a , #08
;; ESTA PORCION DE CODIGO SE PONE ABAJO PARA PROBAR SI SE PUEDE REUTILIZAR APARTE
.pinta8_2:
ld (hl), #FF
inc hl
dec a
