...
;; HASTA AQUI VOY ESTAS INSTRUCCIONES SE USAN PARA PARAR Y VER
;; QUE VALOR TIENE HL Y PODERLO COMPARAR CON 
;; EL VALOR DE MEMORIA
;; ENCONTRAR LA OPERACION QUE PERMITE VALIDAR LOS DOS VALORES
;; (AND, OR,CP, ETC)
;; Y APLICARLA AQUI.
   ld (poshl),hl
   ld d,#07
